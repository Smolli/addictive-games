...
var gamesApp = angular.module('gamesApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'gamesAppUtils', 'pascalprecht.translate', 'truncate']);
